 ...
 */
export class JCC2UserQuestionnaireV3 {
  static create(): ProgrammaticTemplate {
    const builder = new TemplateBuilder()
      .create("JCC2 User Questionnaire V3")
      .description(
        "An improved programmatic version of the JCC2 User Questionnaire, using advanced layout features."
      )
      .author("Nathan Gaul")
      .version("2.0.0")
      .tags("questionnaire", "jcc2", "feedback", "military", "v3");
    ...
    builder
      ...
      .options(effectivenessScale.options)
      .layout("horizontal")
      .grouping(true, "mos_1_1_2_overall")
      .required()
      .end();
    ...
    builder
      ...
      .id("mops_1_1_4_1_2_3_1_3_6_2_3_3_reporting_data_export");
    allJcc2Apps.forEach((app) => {
      const appConditionId = `exp_app_${toId(app)}`;
      builder
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_export`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_export")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_customized`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_customization")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_sorted`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_sorting")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_filtered`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_filtering")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_relevant`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_relevance")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        ...
        .id(`mop_1_1_4_${toId(app)}_saves_time`)
        .options(effectivenessScale.options)
        .layout("horizontal")
        .grouping(true, "mop_1_1_4_time_saving")
        .defaultValue(effectivenessScale.default)
        .required()
        .conditional(appConditionId, "not_equals", ["NA"])
        .end();
    ...
    builder
      ...
      .options(effectivenessScale.options)
      .layout("horizontal")
      .grouping(true, "mop_1_1_4_overall")
      .required()
      .end();
    ...
    builder
      ...
      .id("mop_1_1_5_information_sharing_joint_forces");
    allJcc2Apps.forEach((app) => {
      const appConditionId = `exp_app_${toId(app)}`;
      builder
        .field(
    ...
    builder
      ...
      .id("mop_1_2_1_threat_detection_tasc")
    ...
    builder
      ...
      .id("mop_1_2_2_threat_assessment_crucible")
    ...
    builder
      ...
      .id("mos_1_3_1_common_operating_picture_cop");
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
    ...
    eventCreationApps.forEach((app) => {
      builder
        ...
        .id(`mop_1_3_3_event_creation_${toId(app)}`)
    ...
    builder
      ...
      .id("mop_1_3_4_alerts_situational_awareness");
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
    ...
    builder
      ...
      .id("mop_1_3_5_data_flow_security_levels");
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
    ...
    builder
      ...
      .id("mop_2_1_1_cyber_force_assessment_jcc2_readiness")
    ...
    builder
      ...
      .id("mop_2_1_2_create_manage_target_lists_jcc2_cyber_ops")
    ...
    builder
      ...
      .id("mop_2_1_7_force_deconfliction_jcc2_cyber_ops")
      .conditional("exp_app_jcc2_cyber_ops", "not_equals", ["NA"]);
    builder
      .field(
        "radio",
    ...
    builder
      ...
      .id("mop_2_3_1_mission_change_orders_dispatch")
    ...
    builder
      ...
      .id("mop_2_3_2_jcc2_displays_force_disposition");
    ...
    builder
      ...
      .id("mop_2_4_1_assess_mission_progress_jcc2_cyber_ops")
      .conditional("exp_app_jcc2_cyber_ops", "not_equals", ["NA"]);
    builder
      .field(
        "radio",
    ...
    builder
      ...
      .conditional("mop_2_4_1_workaround_reason", "contains", [
        "Missing capabilities",
        "Partially functional capabilities",
        "External application works better",
      ])
    ...
    builder
      ...
      .id("mos_3_2_1_user_rating_jcc2_training");
    builder
    ...
    builder
      ...
      .id("mos_3_2_2_user_rating_jcc2_documentation");
    builder
      .field(
        "radio",
    ...
    builder
      ...
      .id("mop_3_2_3_user_rating_jcc2_support_help_desk");
    allJcc2Apps.forEach((app) => {
      builder
