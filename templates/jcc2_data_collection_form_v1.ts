 ...
 */
function addStandardTaskQuestions(
...
/**
 * Programmatic template for the JCC2 Data Collection and Interview Form
 */
export class JCC2DataCollectionForm {
  static create(): ProgrammaticTemplate {
    const builder = new TemplateBuilder()
      .create("JCC2 Data Collection and Interview Form")
      .description(
        "A comprehensive data collection form for JCC2 system testing and evaluation"
      )
      .author("Nathan Gaul")
      .version("1.0.0")
      .tags("jcc2", "data-collection", "interview", "military", "testing");
    ...
    jcc2Applications.forEach((app) => {
      ...
      builder
        .field("checkbox", `${app.name} (Pages: ${app.pages})`)
        .id(`app_${appId}`)
        .multiple()
        .options(["Yes", "No"])
        .defaultValue(["No"])
    ...
    builder
      .field("checkbox", "All Applications (Pages: 9, 13, 32-38)")
    ...
    builder
      .section("MOP 2.1.3: Number of users able to simultaneously edit a mission")
      .id("mop_2_1_3")
      .conditional("app_jcc2_cyberops", "contains", ["Yes"])
      .field("checkbox", "Aligns to Test Participant's Role and Duties")
      .id("mop_2_1_3_aligns")
    ...
    builder
      .section("MOP 2.1.4: Number of users able to simultaneously discuss a mission")
      .id("mop_2_1_4")
      .conditional("app_jcc2_cyberops", "contains", ["Yes"])
      .field("checkbox", "Aligns to Test Participant's Role and Duties")
      .id("mop_2_1_4_aligns")
    ...
    builder
      .section("MOP 2.3.1: Mission Change orders can be completed within Dispatch")
      .id("mop_2_3_1")
    ...
    builder
      .section("MOP 2.3.3: Produce reports that are relevant to battle management")
      .id("mop_2_3_3")
      .field("checkbox", "Aligns to Test Participant's Role and Duties")
      .id("mop_2_3_3_aligns")
      .multiple()
    ...
    builder
      ...
      .field(
        "textarea",
        "Test Methodology: The tester will ask the user to open 15 missions on the dashboard"
      )
      .id("mop_2_3_4_methodology")
      .defaultValue(
        "The tester will ask the user to open 15 missions on the dashboard to see if their system functions at a useable level of performance for the user to do their normal work roles."
      )
      .end();
    ...
    for (let i = 1; i <= 10; i++) {
      builder
        .field("text", `Run ${i} - Number of missions able to be tracked simultaneously`)
    ...
    builder
      .section("MOS 3.1.1: Operational Reliability")
      .id("mos_3_1_1")
      .field(
        "textarea",
        "Test Methodology: Record duration of system use and any failures/outages"
      )
      .id("mos_3_1_1_methodology")
      .defaultValue(
        "The test team will record the duration a system is in use and the duration of any failures or outages during the test events. The test team will observe whether there is documentation available to the users which provides steps to diagnose and repair or mitigate the failure."
      )
      .end();
    ...
    builder
      ...
      .end()
      .field("textarea", "What impact did the outage have on your mission / task?")
      .id("mos_3_1_1_impact")
      .end()
      .field(
        "textarea",
    ...
    builder
      .section("MOS 3.1.2: Operational Availability")
      .id("mos_3_1_2");
