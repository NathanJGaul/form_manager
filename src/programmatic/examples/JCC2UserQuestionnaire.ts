...
export class JCC2UserQuestionnaire {
  static create(): ProgrammaticTemplate {
    ...
    builder.section('Role and Echelon')
      ...
      .if('is_cyber_operator == "Yes"')
        .then(b => b.field('text', 'Cyber Operations Division/Team').id('cyber_ops_division_team').required().end())
      .endif()
      ...
      .if('duties.includes("Other(s)")')
        .then(b => b.field('text', 'Other Duties').id('other_duties').required().end())
      .endif();
    ...
    allJcc2Apps.forEach(app => {
        ...
        builder.field('radio', `${app} - Frequency of Use`).id(`${appId}_frequency`).options(frequencyOfUse).required().end()
               ...
               .if(`${appId}_training_received == "Yes"`)
                 .then(b => b.field('text', 'Specify Training Type').id(`${appId}_training_type`).required().end())
               .endif();
    });
    ...
    builder.section('MOS 3.2.1: User rating of JCC2 training')
        ...
        .if('training_initial == "No"')
            .then(b => b.field('textarea', 'Please concisely describe any problems or issues and the operational impact:').id('training_initial_issues').required().end())
        .endif()
        ...
        .if('training_supplemental == "No"')
            .then(b => b.field('textarea', 'Please concisely describe any problems or issues and the operational impact:').id('training_supplemental_issues').required().end())
        .endif()
        .field('radio', 'Do you want (more) training?').id('training_request').options(['Yes', 'N/A', 'No']).required().end()
        .if('training_request == "No" || training_request == "Yes"')
            .then(b => b.field('textarea', 'Please concisely describe any problems or issues and the operational impact:').id('training_request_issues').required().end())
        .endif();
    ...
    builder.section('User Evaluation of Overall System Suitability')
        ...
        .if('eval_internal_interop == "Yes"')
            .then(b => b.field('textarea', 'If yes, please describe the problems, the specific applications involved, and the operational impact:').id('eval_internal_interop_details').required().end())
        .endif()
        ...
        .if('eval_info_sharing == "Yes"')
            .then(b => b.field('textarea', 'If yes, please concisely describe any problems or issues and the operational impact:').id('eval_info_sharing_details').required().end())
        .endif()
        ...
        .if('eval_performance == "Yes"')
            .then(b => b.field('textarea', 'If yes, please describe the specific situations where slowdowns occur, the perceived cause (if known), and the operational impact:').id('eval_performance_details').required().end())
        .endif()
        ...
        .if('eval_access_control == "Yes"')
            .then(b => b.field('textarea', 'If yes, please describe the specific resources you are unable to access and the operational impact:').id('eval_access_control_details').required().end())
        .endif()
        ...
        .if('eval_rbac == "No"')
            .then(b => b.field('textarea', 'If no, please explain why and suggest improvements:').id('eval_rbac_details').required().end())
        .endif()
        ...
        .if('eval_access_requests == "No"')
            .then(b => b.field('textarea', 'If no, please explain the difficulties you have encountered:').id('eval_access_requests_details').required().end())
        .endif()
