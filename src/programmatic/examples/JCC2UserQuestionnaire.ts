...
export class JCC2UserQuestionnaire {
  static create(): ProgrammaticTemplate {
    const builder = new TemplateBuilder()
      ...
      .description(
        "A programmatic version of the JCC2 User Questionnaire PDF, designed for user feedback on JCC2 applications."
      )
      .author("Gemini")
      .version("1.0.0")
    ...
    builder
      ...
      .field("text", "Event")
      .id("event")
      .defaultValue("JCC2 User Questionnaire")
      .end()
      .field("date", "Date")
      .id("date")
    ...
    builder
      ...
      .end()
      .field("radio", "Echelon You Work Within")
      .id("echelon")
      .required()
      ...
      .defaultValue(["Defensive Cyber Operations"])
      .end()
    ...
    operationalExperienceTopics.forEach((topic) => {
      builder
        .field("radio", topic)
        .id(`exp_${topic.toLowerCase().replace(/ /g, "_")}`)
    ...
    specificJcc2AppExperience.forEach((app) => {
      builder
        .field("radio", app)
        .id(`exp_app_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(experienceLevels)
        .required()
        .end();
    });
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        .field("radio", `${app} - Frequency of Use`)
        .id(`${appId}_frequency`)
        ...
        .end()
        .field("radio", `${app} - Training Received`)
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        .field("radio", `JCC2 provides intelligence data within ${app}`)
        .id(appId)
    ...
    allJcc2Apps.forEach((app) => {
      ...
      builder
        .field(
          "radio",
          `Data provided by ${app} allows for the completion of my assigned roles`
        )
        .id(appId)
        .options(effectivenessScale)
        .required()
    ...
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.1.1")
      .id("mop_1_1_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    // Page 6: MOS 1.1.2
    builder
      .section("MOS 1.1.2: Tagging objects of interest")
      .field("checkbox", "Applicable Application(s)")
      .id("mos_1_1_2_apps")
      .multiple()
      .options(["MADSS", "Rally", "SigAct", "Threat Hub"])
      .end();
    ["MADSS", "Rally", "SigAct", "Threat Hub"].forEach((app) => {
      const appId = `mos_1_1_2_tagging_${app.toLowerCase()}`;
      builder
        .field("radio", `Utility of ${app} for Object Tagging`)
        .id(appId)
        .options(effectivenessScale)
        .required()
        .end();
    ...
    ["MADSS", "Rally", "SigAct", "Threat Hub"].forEach((app) => {
      ...
      builder
        .field("radio", `Utility of ${app} for Object Correlation`)
        .id(appId)
        .options(effectivenessScale)
        .required()
        .end();
    ...
    builder
      .field("radio", "Overall Effectiveness rating for MOS 1.1.2")
      .id("mos_1_1_2_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 1.1.3")
      .id("mop_1_1_3_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      .section("MOPS - MOP 1.1.4, MOP 1.2.3, MOP 1.3.6, MOP 2.3.3: Reporting and Data Export")
      .id("reporting_and_data_export")
      .naable();
    allJcc2Apps.forEach((app) => {
      builder
        .field("radio", `Reports generated by ${app} are accurate.`)
        .id(`mop_1_1_4_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q3_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q4_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q5_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q6_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_4_q7_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    ...
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_1_5_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.1.5")
      .id("mop_1_1_5_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    mop121Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `${app} provided applications are accurate in detecting threats.`
        )
        .id(`mop_1_2_1_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    mop121Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `Data provided by ${app} allows me to take action or make decisions about threats.`
        )
        .id(`mop_1_2_1_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.2.1")
      .id("mop_1_2_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .field("radio", "JCC2 provides data to fully assess cyber threats.")
      .id("mop_1_2_2_q1")
      .options(effectivenessScale)
      .required()
      .end()
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 1.2.2")
      .id("mop_1_2_2_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays information that is relevant to my duties.`
        )
        .id(`mos_1_3_1_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays information that is accurate.`
        )
        .id(`mos_1_3_1_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays information that is Complete.`
        )
        .id(`mos_1_3_1_q3_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays information that is timely.`
        )
        .id(`mos_1_3_1_q4_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays information that is not visually cluttered.`
        )
        .id(`mos_1_3_1_q5_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP has adequate sort, filter, and search capabilities.`
        )
        .id(`mos_1_3_1_q6_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `The ${app} application COP displays allow for customization.`
        )
        .id(`mos_1_3_1_q7_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOS 1.3.1")
      .id("mos_1_3_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 1.3.2")
      .id("mop_1_3_2_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    mop133Apps.forEach((app) => {
      builder
        .field("radio", `Event creation is intuitive for ${app}.`)
        .id(`mop_1_3_3_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    mop133Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `${app} provide enough data elements to make detailed incident tickets.`
        )
        .id(`mop_1_3_3_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    mop133Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `${app} provide a DISA tracking number for created incidents.`
        )
        .id(`mop_1_3_3_q3_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.3.3")
      .id("mop_1_3_3_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_3_4_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field(
          "radio",
          `Alerts keep the user informed about current event within their job role in ${app}.`
        )
        .id(`mop_1_3_4_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field("radio", `Alerts received are timely in ${app}.`)
        .id(`mop_1_3_4_q3_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        .field("radio", `The alerts received are configurable in ${app}.`)
        .id(`mop_1_3_4_q4_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.3.4")
      .id("mop_1_3_4_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`mop_1_3_5_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .multiple()
        .options(["NIPR", "SIPR", "JWICS", "Not Applicable"])
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 1.3.5")
      .id("mop_1_3_5_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 2.1.1")
      .id("mop_2_1_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .required()
      .end()
      .field("radio", "Path to target can be displayed within JCC2 Cyber-Ops.")
      .id("mop_2_1_2_q5")
      .options(effectivenessScale)
      .required()
      .end()
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 2.1.2")
      .id("mop_2_1_2_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 2.1.7")
      .id("mop_2_1_7_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      .section(
        "MOP 2.1.9: Joint forces to perform collaborative planning (JCC2 Cyber Ops, JCC2 Readiness)"
      )
    ...
    ["NIPR", "SIPR", "JWICS"].forEach((env) => {
      builder
        .field(
          "radio",
          `When using JCC2 for planning, actions with the application occur with low latency on ${env}`
        )
        .id(`mop_2_1_9_q3_${env.toLowerCase()}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("radio", "Overall Effectiveness rating for MOP 2.1.9")
      .id("mop_2_1_9_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .field("radio", "Dispatch enables the creation of orders.")
      .id("mop_2_3_1_q1")
      .options(effectivenessScale)
      .required()
      .end()
      .field("radio", "Dispatch enables changes to orders to be completed.")
      .id("mop_2_3_1_q2")
      .options(effectivenessScale)
      .required()
      .end()
      .field("radio", "Dispatch enables collaborative order generation.")
      .id("mop_2_3_1_q3")
      .options(effectivenessScale)
      .required()
      .end()
      ...
      .required()
      .end()
      .field("radio", "Orders generated within Dispatch are accurate.")
      .id("mop_2_3_1_q5")
      .options(effectivenessScale)
      .required()
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 2.3.1")
      .id("mop_2_3_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      .section(
        "MOP 2.3.2: JCC2 displays force disposition (JCC2 Readiness, JCC2 Cyber Ops)"
      )
      .field(
        "radio",
        "Effectiveness rating for JCC2 facilitating the desired task."
      )
      .id("mop_2_3_2_q1")
      .options(effectivenessScale)
      .required()
    ...
    builder
      ...
      .id("mop_2_4_1_q3_details")
      .end()
      .field("radio", "Overall Effectiveness rating for MOP 2.4.1")
      .id("mop_2_4_1_overall")
      .options(effectivenessScale)
      .required()
      .end();
    ...
    builder
      ...
      .id("training_initial_issues")
      .required()
      .conditional("training_initial", "equals", ["No"])
      .end()
      ...
      .id("training_supplemental_issues")
      .required()
      .conditional("training_supplemental", "equals", ["No"])
      .end()
      ...
      .id("training_request_issues")
      .required()
      .conditional("training_request", "equals", ["No", "Yes"])
      .end();

    const trainingAssessmentItems = [
      {
        id: "training_assessment_info_relevant",
        label:
          "All of the information covered was relevant to how I interact with the system.",
      },
      {
        id: "training_assessment_prepared_easy",
        label:
          "The training prepared me to easily use the system to accomplish my mission.",
      },
      {
        id: "training_assessment_portrayed_ops",
        label: "Training accurately portrayed operations in the field.",
      },
      {
        id: "training_assessment_prepared_interact",
        label: "The training prepared me to properly interact with the system.",
      },
      {
        id: "training_assessment_prepared_solve",
        label: "Training prepared me to solve common problems.",
      },
      {
        id: "training_assessment_covered_important",
        label:
    ...
    allJcc2Apps.forEach((app) => {
      builder
        .field("radio", `Rate the effectiveness of ${app} training.`)
        .id(`training_summative_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      .field("textarea", "Additional observations (positive or negative):")
    ...
    allJcc2Apps.forEach((app) => {
      builder
        .field("radio", `Rate the effectiveness of ${app} documentation.`)
        .id(`doc_summative_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    ...
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`helpdesk_q1_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`helpdesk_q2_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`helpdesk_q3_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    allJcc2Apps.forEach((app) => {
      builder
        ...
        .id(`helpdesk_q4_${app.toLowerCase().replace(/ /g, "_")}`)
        .options(effectivenessScale)
        .required()
        .end();
    });
    builder
      ...
      .id("helpdesk_additional_observations")
      .end();
